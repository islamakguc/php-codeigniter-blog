              ...
              <div class="panel-body">
                ...
                <tbody>
                 ...
                 foreach ($veri as $rs) 
                 {
                   ?>
                   <tr class="odd gradeX">
                     <td><a href="<?= base_url() ?>uye/Yazilar/edit/<?=$rs->id?>"><?=kisalt($rs->baslik)?></a></td>  
                     ...
                     <td class="center"><?php
                      ...
                      <td class="center">
                        ...
                        if($rs->resim==NULL)
                          { ?>
                        <a href="<?= base_url() ?>Uye/Yazilar/resimekle/<?=$rs->id;?>">Resim Ekle</a>
                        <?php }
                        else
                          { ?>
                      ...
                      <td class="center" style="text-align: center;"><a href="<?= base_url() ?>uye/Yazilar/resim_galeri_ekle/<?=$rs->id;?>"><img height="30" width="30" src="<?= base_url() ?>assets/images/galery.png"></a></td>
