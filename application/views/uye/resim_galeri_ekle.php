...
<div id="page-wrapper">
            ...
            <div class="col-lg-12">
               ...
               <div>
                <ul class="breadcrumb">
                 ...
                 <li>
                    <a href="<?= base_url() ?>uye/Yazilar/resim_galeri_ekle/resim[0]->id<">Resim Ekle</a>
                </li>
            </ul>
        </div>
        <?php 
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body"><br>
           <?php echo form_open_multipart(base_url().'uye/Yazilar/resim_galeri_upload/'.$resim[0]->id);?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <h4><a href="#" title="Nature Portfolio">İslam AKGÜÇ</a></h4>
                            <span class="pull-right">
                               <a href="<?= base_url() ?>uye/Yazilar/deletegaleri/<?=$rs->id?>/<?=$rs->yazi_id?>"> <i id="like1" class="fa fa-times"></i></a>
                            </span>
                        </div>
                    </div>
                </article>
