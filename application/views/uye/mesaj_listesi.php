                    ...
                    <div class="panel-body">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                <li><a href="<?php echo base_url() ?>uye/Mesaj/sil/<?php echo $row->id;?>" onclick="return confirm('Silinecek !! emin misiniz. ?');">Sil</a></li>
                                <li><a href="<?php echo base_url() ?>uye/Mesaj/oku/<?php echo $row->id;?>">Oku</a></li>
                            </ul>
                        </div>
