    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
             ...
             <div>
                ...
                <li>
                    <a href="<?= base_url() ?>uye/Yorum/edit/<?php echo $data[0]->id; ?>">Yorum Düzenle</a>
                </li>
            </ul>
        </div>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" action="<?= base_url() ?>uye/Yorum/guncellekaydet/<?php echo $data[0]->id; ?>" method="post">
