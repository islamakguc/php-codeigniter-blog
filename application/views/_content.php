              ...
              <div class="col-md-4">
                ...
                <div class="col-md-8">
                  <div class="post-title">
                    <h3 ><a href="<?= base_url() ?>Home/yazi_goster/<?=$rs->link?>" title="<?=$rs->baslik?>"><?=$rs->baslik?></a></h3>
                    <span class="meta-data" style="font-size: 12px;"><i class="fa fa-calendar"></i> <?php echo turkcetarih('j F Y , l',$rs->tarih); ?> - 
                      ...
                      <a href="<?= base_url() ?>Home/kategori/<?=$kategori[0]->kategoriadi?>" title="<?=$kategori[0]->kategoriadi?>"><?=$kategori[0]->kategoriadi; ?></a>
                      - <a href="<?= base_url() ?>Home/yazar/<?=$yazar[0]->link?>" title="<?=$yazar[0]->ad?>"><?=$yazar[0]->ad?></a>
