                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-8">
                          <div class="post-title">
                            <h5 ><a href="<?= base_url() ?>Home/yazi_goster/<?=$rs->id?>" title="<?=$rs->baslik?>"><?=$rs->baslik?></a></h3>
                            <span class="meta-data" style="font-size: 12px;"><i class="fa fa-calendar"></i> <?php echo turkcetarih('j F Y , l',$rs->tarih); ?> - <a href="<?= base_url() ?>Home/kategori/<?=$rs->kategori_id?>" title=""><?=$rs->katadi?></a>- <a href="<?= base_url() ?>Home/yazar/<?=$rs->yazar_id?>" title="<?=$rs->yazar_ad?>"><?=$rs->yazar_ad?></a>
